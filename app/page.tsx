...
const page = () => {
  return (
        ...
        <nav className="col-span-1 row-span-3 bg-gray-700 pt-6">
          ...
          <div>
            <h3
              className="text-xs text-gray-100 uppercase text-white px-6 tracking-widest font-light mb-4"
            >
              Playlists
            </h3>
            <div className="mb-3">
            ...
            <div>
              <div
                className="px-6 py-2 flex items-center text-sm text-white text-gray-100 hover:text-white"
              >
                Liked from Radio
              </div>
              <div
        ...
        <main className="col-span-5 row-span-3 overflow-auto">
          ...
          <section className="px-6 grid gap-6 mb-8">
            <div className="flex items-center">
              ...
              <div>
                <a className="text-xs text-gray-100 tracking-widest uppercase hover:underline"
                  href="">See all
                </a>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <div className="overflow-hidden relative flex-1 mx-2 rounded">
                ...
                <div
                  className="absolute inset-x-0 top-0 -translate-x-48 border-b-4 border-gray-100 rounded transform hover:border-green-200"
                ></div>
              </div>
